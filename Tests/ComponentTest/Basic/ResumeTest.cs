...
namespace ComponentTest.Basic
{
    ...
    public class ResumeTest
    {
        ...
        [TestMethod]
        public async Task UpdateResume()
        {
            string id;
            try
            {
            ...
            try
            {
                ResumeUpdateRequest request = new()
                {
                };
                await _client.Resumes[id].PatchAsync(request);
            }
            catch (Exception exception)
            {
                Assert.Fail(exception.Message);
        ...
        [TestMethod]
        public async Task UpdateResume_Overwrite()
        {
            string id;
            try
            {
        ...
        [TestMethod]
        public async Task UpdateResume_InvalidId()
        {
            try
            {
                string id = "InvalidId";
